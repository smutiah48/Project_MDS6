      ...
      tabItem(tabName = "searchAuthors",
              fluidRow(
                box(title = "Cari Penulis", status = "primary", solidHeader = TRUE, collapsible = TRUE, width = 12,
                    ...
                    # Tambahkan ini di dalam box title "Cari Penulis"
                    selectInput("bookInput", "Pilih Buku", choices = getChoices("SELECT DISTINCT judul_buku FROM buku ORDER BY judul_buku")),
          ...
          tabPanel(
            ...
            fluidRow(
              box(
                ...
                plotOutput("distribusiBukuPerKategori"),
                width = 12
              )
            )
          ),
          tabPanel(
            title = "Tren Penerbitan",
            fluidRow(
              box(
                title = "Tren Penerbitan Buku",
                plotOutput("trenPenerbitanBuku"),
                width = 12
              )
            )
          ),
          tabPanel(
            title = "Rata-rata Halaman per Kategori",
            fluidRow(
              box(
                title = "Rata-rata Halaman per Kategori",
                tableOutput("avgPagesPerCategory"), # Ini harus sesuai dengan outputId di server
                width = 12
              )
            )
          ),
          
          # Untuk Grafik Interaktif dengan Plotly
          tabPanel(
            title = "Grafik Interaktif",
            fluidRow(
              box(
                title = "Eksplorasi Data Buku",
                plotlyOutput("interactivePlot"), # Ini harus sesuai dengan outputId di server
                width = 12
              )
            )
          ),
              ...
              fluidRow(
                box(title = "Tim Kami", status = "primary", solidHeader = TRUE, collapsible = TRUE, width = 12,
                    div(class = "team-section",
                        ...
                        p("Kami adalah tim yang bersemangat dan berdedikasi dalam menciptakan solusi inovatif yang dapat mengatasi tantangan teknologi masa kini. Dengan keahlian dan pengalaman yang beragam, kami bertekad untuk memberikan kontribusi terbaik kami untuk menciptakan solusi yang dapat bermanfaat bagi banyak orang, salah satunya dengan berkolaborasi membentuk Electronic Literatur. Berikut adalah wajah dibalik Electronic Literatur"),
                        div(class = "row",
                            # Team member 1
                            div(class = "col-md-4",
                                div(class = "card",
                                    img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/ABD.jpg?raw=true", class = "card-img-top"),
                                    div(class = "card-body",
                                        h4(class = "card-title", "Abd. Rahman S.Stat"),
                                        h5(class = "card-subtitle mb-2 text-muted", "Database Manager"),
                                        p(class = "card-text", "Moto hidup: membaca adalah jendela dunia, membuatmu bijak dalam banyak hal.")
                                    ),
                                    div(class = "card-footer", "G1501231055")
                                )
                            ),
                            # Team member 2
                            div(class = "col-md-4",
                                div(class = "card",
                                    img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Meisya.jpg?raw=true", class = "card-img-top"),
                                    div(class = "card-body",
                                        h4(class = "card-title", "Meisyatul Ilma, S.Si"),
                                        h5(class = "card-subtitle mb-2 text-muted", "Technical Writer"),
                                        p(class = "card-text", "Moto hidup: Sebaik-baiknya manusia adalah yang paling bermanfaat.")
                                    ),
                                    div(class = "card-footer", "G1501231073")
                                )
                            ),
                            # Team member 3
                            div(class = "col-md-4",
                                div(class = "card",
                                    img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Riska.JPG?raw=true", class = "card-img-top"),
                                    div(class = "card-body",
                                        h4(class = "card-title", "Riska Yulianti, S.Stat"),
                                        h5(class = "card-subtitle mb-2 text-muted", "Backend Developer"),
                                        p(class = "card-text", "Moto hidup: Everything will be okay in the end, if its not okay, its not the end.")
                                    ),
                                    div(class = "card-footer", "G1501231058")
                                )
                            ),
                            # Team member 4
                            div(class = "col-md-4",
                                div(class = "card",
                                    img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Mutiah.JPG?raw=true", class = "card-img-top"),
                                    div(class = "card-body",
                                        h4(class = "card-title", "Siti Mutiah, S.Pd"),
                                        h5(class = "card-subtitle mb-2 text-muted", "Frontend Developer"),
                                        p(class = "card-text", "Moto hidup: Wa ilaa rabbika farghab")
                                    ),
                                    div(class = "card-footer", "G1501231027")
                                )
                            )
                        )
                    )
