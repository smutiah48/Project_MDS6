                ...
                box(title = "Tim Kami", status = "primary", solidHeader = TRUE, collapsible = TRUE, width = 12,
                    div(class = "team-section",
                        ...
                        div(class = "team-member",
                            img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/ABD.jpg?raw=true", class = "team-photo"),
                            h3("Abd. Rahman (G1501231055)"),
                            h4("Database Manager"),
                            p("moto hidup: gak apa pelan asal selamat.")
                        ),
                        div(class = "team-member",
                            img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Meisya.jpg?raw=true", class = "team-photo"),
                            h3("Meisyatul Ilma, S.Si (G1501231073)"),
                            h4("Technical Writer"),
                            p("moto hidup: Sebaik-baiknya manusia adalah yang paling bermanfaat.")
                        ),
                        div(class = "team-member",
                            img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Riska.JPG?raw=true", class = "team-photo"),
                        ...
                        div(class = "team-member",
                            img(src = "https://github.com/smutiah48/Project_MDS6/blob/main/scr/Mutiah.JPG?raw=true", class = "team-photo"),
